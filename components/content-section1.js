...
const ContentSection1 = (props) => {
  return (
    <>
      <div
        className={`content-section1-content-section ${props.rootClassName} `}
      >
        <h1 className="content-section1-text">
          <span>Fencing Experts</span>
          <br></br>
        </h1>
        <div className="content-section1-content-body-row ContentBodyRowParagraph">
          <span className="content-section1-text03">
            <span>
            ...
            <span>
              <span>
                ...
                only do we offer a wide range of pool fence options, but we also
                provide free estimates and special offers to help you save on
      ...
      <style jsx>
        {`
          .content-section1-content-section {
            width: 100%;
            height: auto;
            display: flex;
          ...
          .content-section1-content-body-row {
            height: auto;
          }
          .content-section1-text03 {
            width: 100%;
            z-index: 100;
          }
